...
const CheckOutPage = () => {
    ...
    try {
      ...
      const orderData = {
        ...
        items: cartItems.map((item) => ({
          productId: item._id,
          title: item.title,
          price: item.newPrice || parseFloat(item.price.replace("$", "")),
          quantity: item.quantity || 1,
          coverImage: item.coverImage, // Make sure this is included
        })),
        paymentMethod: "cash",
  ...
  return (
    <>
      <title>Checkout - Super Books</title>
